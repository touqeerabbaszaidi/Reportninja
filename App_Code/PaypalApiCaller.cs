...
/// <summary>
/// Summary description for PaypalApiCaller
/// </summary>
public class PaypalApiCaller
{
	public PaypalApiCaller()
	{
		//
        ...
        //private string returnURL = "http://" + HttpContext.Current.Request.Url.Authority + "/GetMoreSpace.aspx?action=success";
        //private string cancelURL = "http://" + HttpContext.Current.Request.Url.Authority + "/GetMoreSpace.aspx?action=failure";
        private string returnURL = HttpContext.Current.Request.Url.ToString() + "?action=success";
        private string cancelURL = HttpContext.Current.Request.Url.ToString() + "?action=failure";
        ...
        //public string APIUsername = "aabhat_1361186324_biz_api1.gmail.com";
        //private string APIPassword = "1361186350";
        //private string APISignature = "A9129uueptc9dv74eYpg.UwRDpfWARQxVVhBx2igRxcqbh1T4Yst0o5H"; 
        public string APIUsername = System.Configuration.ConfigurationManager.AppSettings["PayPalAPIUsername"].ToString();
        private string APIPassword = System.Configuration.ConfigurationManager.AppSettings["PayPalAPIPassword"].ToString();
        private string APISignature = System.Configuration.ConfigurationManager.AppSettings["PayPalSignature"].ToString();
        //public string APIUsername = "aabhat_1361186324_biz_api1.gmail.com";
        //private string APIPassword = "1361186350";
        //private string APISignature = "A9129uueptc9dv74eYpg.UwRDpfWARQxVVhBx2igRxcqbh1T4Yst0o5H";
